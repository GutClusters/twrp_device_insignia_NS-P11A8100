...
TARGET_BOOTLOADER_BOARD_NAME := NS-P11A8100     # From ro.product.board
...
DEVICE_RESOLUTION := 1366x768               # The Resolution of your Device
TARGET_SCREEN_HEIGHT := 768                    # The height
TARGET_SCREEN_WIDTH := 1366                      # The width
